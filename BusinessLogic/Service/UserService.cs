...
namespace BusinessLogic.Service
{
    public class UserService : IUserService
    {
        ...
        public async Task<UserDetailDto?> GetUserDetailAsync(string id)
        {
            ...
            else if ((user.Role.RoleName == RoleEnum.Staff || user.Role.RoleName == RoleEnum.Admin) && user.StaffProfile != null)
            {
        ...
        public async Task<bool> UpdateProfileAsync(string userId, UpdateProfileRequest request)
        {
            ...
            else if (user.Role.RoleName == RoleEnum.Staff || user.Role.RoleName == RoleEnum.Admin)
            {
